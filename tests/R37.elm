...
testCases =
    List.indexedMap (\i a -> ( i + 1, a )) totientUntil500
...
suite =
    describe "P37"
        (List.map
            (\( input, out ) ->
                test ("Euler's totient function " ++ String.fromInt input ++ " = " ++ String.fromInt out) <|
